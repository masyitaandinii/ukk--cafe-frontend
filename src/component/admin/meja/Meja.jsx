                                ...
                                <div className="px-6 py-6 lg:px-8">
                                    ...
                                    <form className="space-y-6" onSubmit={putMeja}>
                                        <div>
                                            ...
                                            }} type="text" value={prevData.nomor_meja || ""} id="nomor" className="text-sm rounded-lg block w-full p-2.5 bg-white border-gray-600 placeholder-gray-400 text-black focus:ring-blue-500 focus:border-blue-500" name="nomor_meja" onChange={handleChange_Edit} autoComplete="off" required />
                                        </div>
                                        {/* <div>
                                            <label htmlFor="status" className="block mb-2 text-sm font-medium text-white">Status</label>
